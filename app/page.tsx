        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/roblox" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Roblox Script</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/services/website" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Website Creation</Link>
              <Link href="/services/discord-bot" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Discord Bots</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/support" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Support</Link>
              <Link href="/status" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Status</Link>
              <Link href="/terms" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Terms of Service</Link>
              <a href="https://discord.gg/Kezxm2TyGY" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-400 transition-colors text-xs font-mono">Discord</a>
            </div>
          </div>
        </div>
