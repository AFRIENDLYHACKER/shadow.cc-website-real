        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 group mb-3">
              ...
              <span className="text-sm font-mono font-bold text-white tracking-wider group-hover:text-red-400 transition-colors">SHADOW<span className="text-red-500">.</span>CC</span>
            </Link>
            <p className="text-zinc-400 text-xs font-mono leading-relaxed">Premium digital services. Scripts, websites, bots, AI, and security.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/roblox" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Roblox Script</Link>
              <Link href="/antivirus" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Antivirus</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/services/website" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Website Creation</Link>
              <Link href="/services/discord-bot" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Discord Bots</Link>
              <Link href="/services/ai" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">AI Solutions</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/support" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Support</Link>
              <Link href="/status" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Status</Link>
              <Link href="/terms" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Terms of Service</Link>
              <a href="https://discord.gg/Kezxm2TyGY" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-red-400 transition-colors text-xs font-mono">Discord</a>
            </div>
          </div>
        </div>

        <div className="border-t border-zinc-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-zinc-500 text-[10px] font-mono tracking-wider">2026 SHADOW.CC. ALL RIGHTS RESERVED.</p>
          <a href="https://discord.gg/Kezxm2TyGY" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-red-400 transition-colors" aria-label="Discord">
